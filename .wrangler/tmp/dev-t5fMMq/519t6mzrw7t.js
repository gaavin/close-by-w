...
// .wrangler/tmp/bundle-7sZXP8/checked-fetch.js
...
// .wrangler/tmp/pages-SzTLAg/bundledWorker-0.33156557066765524.mjs
...
var _o = (e, t, n2, s, r, o, i) => (ko(e, s, r.props.props), k(wt(e, s), (c) => {
  ...
  return s.$id$ = p2, t.$static$.$contexts$.push(s), Fs(S2, s, d2, l2, u, n2, o, (m) => {
    if (s.$flags$ & ge) {
      ...
      for (const _2 of E3) {
        const g2 = Hs(_2[0]);
        b[g2] = Vn(_2[1], e.$static$.$containerState$, w), nn(g2, e.$static$.$containerState$);
      }
      _n("script", b, m);
    }
    ...
    if (f2) {
      const w = Object.keys(f2).map((_2) => {
        const g2 = f2[_2];
        if (g2)
          return qe("q:template", { [K]: _2 || true, hidden: true, "aria-hidden": "true" }, null, g2, 0, null);
      }), [h, b] = u.$projectedCtxs$, E3 = lt(h);
      E3.$slotCtx$ = s, y = X(w, E3, b, m, 0, void 0);
    }
    return i ? k(y, () => i(m)) : y;
  });
}));
...
var qn = (e, t, n2, s, r, o) => {
  ...
  if (typeof i == "string") {
    ...
    const b = (g2, x2, T2) => {
      ...
      if (vn(g2))
        return void wn(p2.li, g2, x2, void 0);
      if (D(x2) && (x2 = ae(x2, T2 ? [1, v2, x2, c.$element$, g2] : [2, c.$element$, x2, v2, g2]), f2 = true), g2 === L)
        return void (h = x2);
      let R2;
      g2.startsWith(Ts) && nn(g2.slice(15), t.$static$.$containerState$);
      const I3 = g2 === "htmlFor" ? "for" : g2;
      I3 === "class" || I3 === "className" ? w = bt(x2) : I3 === "style" ? R2 = Wt(x2) : Os(I3) || I3 === "draggable" || I3 === "spellcheck" ? (R2 = x2 != null ? String(x2) : null, x2 = R2) : R2 = x2 === false || x2 == null ? null : String(x2), R2 != null && (I3 === "value" && i === "textarea" ? h = Pe(R2) : No(I3) || (m += " " + (x2 === true ? I3 : I3 + '="' + Pe(R2) + '"')));
    };
    for (const g2 in u) {
      let x2 = false, T2;
      g2 in d2 ? (x2 = true, T2 = d2[g2], T2 === N && (T2 = u[g2])) : T2 = u[g2], b(g2, T2, x2);
    }
    for (const g2 in d2) {
      if (g2 in u)
        continue;
    ...
    if (c) {
      if ((l2 = c.$scopeIds$) != null && l2.length) {
        const g2 = c.$scopeIds$.join(" ");
        w = w ? `${g2} ${w}` : g2;
      }
      c.$flags$ & ge && (E3.push(...c.li), c.$flags$ &= ~ge);
    }
    if (S2 && (r |= 1), i in To && (r |= 16), i in Io && (r |= 8), w && (m += ' class="' + Pe(w) + '"'), E3.length > 0) {
      const g2 = Sn(E3), x2 = !!(16 & r);
      for (const T2 of g2) {
        const R2 = x2 ? Hs(T2[0]) : T2[0];
        m += " " + R2 + '="' + Vn(T2[1], t.$static$.$containerState$, p2) + '"', nn(R2, t.$static$.$containerState$);
      }
    }
    if (a != null && (m += ' q:key="' + Pe(a) + '"'), y || f2 || E3.length > 0) {
      if (y || f2 || Ao(E3)) {
        const g2 = Ye(t);
        m += ' q:id="' + g2 + '"', p2.$id$ = g2;
      }
    ...
    return k(_2, () => {
      if (S2) {
        for (const g2 of n2.$static$.$headNodes$)
          _n(g2.type, g2.props, s);
...
var Qo = (e) => {
  ...
  const d2 = Nr(o, n2), p2 = /* @__PURE__ */ new Map(), v2 = /* @__PURE__ */ new Set(), S2 = (f2) => (typeof f2 == "string" && f2.length > 0, p2.has(f2) ? p2.get(f2) : m(f2)), m = (f2) => {
    if (f2.startsWith("#")) {
      ...
      return we(g2) ? (p2.set(f2, g2), U(g2, o), g2) : (p2.set(f2, g2), g2);
    }
    if (f2.startsWith("@")) {
      const E3 = f2.slice(1), _2 = ee(E3);
      return r[_2];
  ...
  if (e.$slotCtx$ ? (p2.$parentCtx$ = e.$slotCtx$, p2.$realParentCtx$ = e.$cmpCtx$) : p2.$parentCtx$ = e.$cmpCtx$, l2) {
    if ("q:renderFn" in a) {
      ...
      const b = k(Tn(e, p2, n2), () => {
        ...
        const _2 = yr(p2), g2 = [], x2 = hr(E3);
        for (const T2 in x2) {
          const R2 = x2[T2], I3 = gr(u, _2, p2, T2, u.$containerState$), oe2 = lt(e), Re4 = I3.$element$;
          oe2.$slotCtx$ = I3, I3.$vdom$ = R2, R2.$elm$ = Re4;
          let V2 = n2 & ~J;
          Re4.isSvg && (V2 |= J);
          for (const C2 of R2.$children$) {
            const Ve4 = Ee(oe2, C2, V2, g2);
            C2.$elm$, C2.$elm$, br(u, Re4, Ve4);
          }
        }
        return Ne(g2);
      });
...
var fc = async (e, t, n2, s) => {
  ...
  for (const h of e) {
    const b = h.$element$, E3 = h.li;
    for (const _2 of E3)
      if (we(b)) {
        const g2 = _2[1], x2 = g2.$captureRef$;
        if (x2)
          for (const T2 of x2)
            q(T2, r, true);
  ...
  for (const h of l2) {
    ...
    for (const g2 of b) {
      const x2 = g2[1];
      g2[0] === 0 && Se(x2) && se(x2) && !r.$elements$.includes(Y(x2)) || _2.push(g2);
    }
  ...
  for (const h of l2) {
    ...
    if (b == null)
      break;
    S2.push(b.map((E3) => typeof E3 == "number" ? `_${E3}` : o$(E3, u)).filter(xs));
  }
  S2.length, p2.size;
  const m = Tr(l2, d2, u, r, t), f2 = {}, y = {};
  for (const h of e) {
    const b = h.$element$, E3 = h.$id$, _2 = h.$refMap$, g2 = h.$props$, x2 = h.$contexts$, T2 = h.$tasks$, R2 = h.$componentQrl$, I3 = h.$seq$, oe2 = {}, Re4 = se(b) && r.$elements$.includes(h);
    if (_2.length > 0) {
      const V2 = xe(_2, d2, " ");
      V2 && (y[E3] = V2);
    } else if (c) {
...
var U$ = ({ track: e }) => {
  ...
  async function d2() {
    ...
    if (w = new URL(v2.dest, u.url), b = o.loadedRoute, h = o.response, b) {
      const [E3, _2, g2, x2] = b, T2 = g2, R2 = T2[T2.length - 1];
      v2.dest.search && (w.search = v2.dest.search), u.prevUrl = f2, u.url = w, u.params = { ..._2 }, a.untrackedValue = { type: y, dest: w };
      const I3 = P$(h, u, T2, m);
      n2.headings = R2.headings, n2.menu = x2, s.value = Gt(T2), r.links = I3.links, r.meta = I3.meta, r.styles = I3.styles, r.scripts = I3.scripts, r.title = I3.title, r.frontmatter = I3.frontmatter;
    }
  }
  return d2();
};
...
var be2 = ((s) => typeof __require2 < "u" ? __require2 : typeof Proxy < "u" ? new Proxy(s, { get: (e, n2) => (typeof __require2 < "u" ? __require2 : e)[n2] }) : s)(function(s) {
...
var ye2 = "<sync>";
function Z2(s, e) {
  const n2 = e == null ? void 0 : e.mapper, t = s.symbolMapper ? s.symbolMapper : (o, l2, i) => {
    var a;
    if (n2) {
      const c = N2(o), d2 = n2[c];
      if (!d2) {
        if (c === ye2)
          return [c, ""];
        ...
        if (i)
          return [o, `${i}?qrl=${o}`];
        console.error("Cannot resolve symbol", o, "in", n2, i);
      }
      return d2;
    }
  };
  return { isServer: true, async importSymbol(o, l2, i) {
    var v2;
    const a = N2(i), c = (v2 = globalThis.__qwik_reg_symbols) == null ? void 0 : v2.get(a);
    if (c)
      return c;
    let d2 = String(l2);
    ...
    return q3[i];
  }, raf: () => (console.error("server can not rerender"), Promise.resolve()), nextTick: (o) => new Promise((l2) => {
    setTimeout(() => {
      l2(o());
    });
  }), chunkForSymbol(o, l2, i) {
    return t(o, n2, i);
  } };
}
async function ve2(s, e) {
  const n2 = Z2(s, e);
  K$(n2);
}
var N2 = (s) => {
...
function ke2(s, e) {
  const n2 = { bundles: j2(e).map((r) => r.split("/").pop()) };
...
function j2(s) {
  const e = [], n2 = (t) => {
    if (Array.isArray(t))
      for (const r of t)
        e.includes(r.url) || (e.push(r.url), n2(r.imports));
  };
  return n2(s), e;
}
function ze2(s) {
  ...
  const t = (i, a) => {
    if (Array.isArray(i))
      for (const c of i) {
        ...
        e.set(c.url, d2 + 1), n2++, a.has(c.url) || (a.add(c.url), t(c.imports, a));
      }
  }, r = /* @__PURE__ */ new Set();
  for (const i of s)
    r.clear(), t(i.imports, r);
  const o = n2 / e.size * 2, l2 = Array.from(e.entries());
  return l2.sort((i, a) => a[1] - i[1]), l2.slice(0, 5).filter((i) => i[1] > o).map((i) => i[0]);
}
function xe2(s, e, n2, t) {
  const r = Ce2(e == null ? void 0 : e.implementation), o = [];
  return r.prefetchEvent === "always" && Se2(s, o, n2, t), r.linkInsert === "html-append" && Ne2(o, n2, r), r.linkInsert === "js-append" ? Ee2(o, n2, r, t) : r.workerFetchInsert === "always" && Oe2(o, n2, t), o.length > 0 ? Do(je, { children: o }) : null;
}
function Se2(s, e, n2, t) {
  const r = ze2(n2);
  for (const o of r)
    e.push(Do("link", { rel: "modulepreload", href: o, nonce: t }));
  e.push(Do("script", { "q:type": "prefetch-bundles", dangerouslySetInnerHTML: ke2(s, n2) + "document.dispatchEvent(new CustomEvent('qprefetch', {detail:{links: [location.pathname]}}))", nonce: t }));
}
function Ne2(s, e, n2) {
  const t = j2(e), r = n2.linkRel || "prefetch";
  for (const o of t) {
    const l2 = {};
    l2.href = o, l2.rel = r, (r === "prefetch" || r === "preload") && o.endsWith(".js") && (l2.as = "script"), s.push(Do("link", l2));
  }
}
function Ee2(s, e, n2, t) {
  const r = n2.linkRel || "prefetch";
  let o = "";
  n2.workerFetchInsert === "no-link-support" && (o += "let supportsLinkRel = true;"), o += `const u=${JSON.stringify(j2(e))};`, o += "u.map((u,i)=>{", o += "const l=document.createElement('link');", o += 'l.setAttribute("href",u);', o += `l.setAttribute("rel","${r}");`, n2.workerFetchInsert === "no-link-support" && (o += "if(i===0){", o += "try{", o += `supportsLinkRel=l.relList.supports("${r}");`, o += "}catch(e){}", o += "}"), o += "document.body.appendChild(l);", o += "});", n2.workerFetchInsert === "no-link-support" && (o += "if(!supportsLinkRel){", o += E(), o += "}"), n2.workerFetchInsert === "always" && (o += E()), s.push(Do("script", { type: "module", "q:type": "link-js", dangerouslySetInnerHTML: o, nonce: t }));
}
function Oe2(s, e, n2) {
  let t = `const u=${JSON.stringify(j2(e))};`;
  t += E(), s.push(Do("script", { type: "module", "q:type": "prefetch-worker", dangerouslySetInnerHTML: t, nonce: n2 }));
}
function Ce2(s) {
  return { ...Ie2, ...s };
}
...
function De2(s, e, n2) {
  ...
  if (t !== null) {
    ...
    if (typeof t.symbolsToPrefetch == "function")
      try {
        return t.symbolsToPrefetch({ manifest: n2.manifest });
      } catch (o) {
...
function Ae2(s, e, n2) {
  const t = [], r = s == null ? void 0 : s.qrls, { mapper: o, manifest: l2 } = e, i = /* @__PURE__ */ new Map();
  if (Array.isArray(r))
    for (const a of r) {
      const c = a.getHash(), d2 = o[c];
      if (d2) {
        const q3 = d2[1];
        se2(l2, i, t, n2, q3);
      }
...
function M2(s = {}) {
  return s.debug ? Re : Te2;
}
var Pe2 = "<!DOCTYPE html>";
async function Be2(s, e) {
  var P2, B4, F4;
  let n2 = e.stream, t = 0, r = 0, o = 0, l2 = 0, i = "", a;
  const c = ((P2 = e.streaming) == null ? void 0 : P2.inOrder) ?? { strategy: "auto", maximunInitialChunk: 5e4, maximunChunk: 3e4 }, d2 = e.containerTagName ?? "html", q3 = e.containerAttributes ?? {}, v2 = n2, oe2 = S(), te3 = ee2(e), p2 = ne2(e.manifest);
  function C2() {
    i && (v2.write(i), i = "", t = 0, o++, o === 1 && (l2 = oe2()));
  }
  function I3(m) {
    const f2 = m.length;
    t += f2, r += f2, i += m;
  ...
  const re3 = S(), A2 = [];
  let T2 = 0, R2 = 0;
  await X$(s, { stream: n2, containerTagName: d2, containerAttributes: q3, serverData: e.serverData, base: te3, beforeContent: k4, beforeClose: async (m, f2, L3, x2) => {
    var V2, G4, K2, $, Q3;
    T2 = re3();
    const b = S();
    a = await fc(m, f2, void 0, x2);
    const h = [];
    if (e.prefetchStrategy !== null) {
      const w = De2(a, e, p2), ce4 = q3["q:base"];
      if (w.length > 0) {
        const H5 = xe2(ce4, e.prefetchStrategy, w, (V2 = e.serverData) == null ? void 0 : V2.nonce);
        H5 && h.push(H5);
      }
    }
    const le4 = JSON.stringify(a.state, void 0, void 0);
    if (h.push(Do("script", { type: "qwik/json", dangerouslySetInnerHTML: Le2(le4), nonce: (G4 = e.serverData) == null ? void 0 : G4.nonce })), a.funcs.length > 0) {
      const w = q3[ge2];
      h.push(Do("script", { "q:func": "qwik/json", dangerouslySetInnerHTML: Ve(w, a.funcs), nonce: (K2 = e.serverData) == null ? void 0 : K2.nonce }));
    }
    const ae3 = !a || a.mode !== "static", W4 = z4 === "always" || z4 === "auto" && ae3;
    if (W4) {
      const w = M2({ debug: e.debug });
      h.push(Do("script", { id: "qwikloader", dangerouslySetInnerHTML: w, nonce: ($ = e.serverData) == null ? void 0 : $.nonce }));
    }
    const J4 = Array.from(f2.$events$, (w) => JSON.stringify(w));
    if (J4.length > 0) {
      const w = (W4 ? "window.qwikevents" : "(window.qwikevents||=[])") + `.push(${J4.join(", ")})`;
      h.push(Do("script", { dangerouslySetInnerHTML: w, nonce: (Q3 = e.serverData) == null ? void 0 : Q3.nonce }));
    }
    return We2(A2, m), R2 = b(), Do(je, { children: h });
  }, manifestHash: (p2 == null ? void 0 : p2.manifest.manifestHash) || "dev" + Fe2() }), d2 !== "html" && n2.write("<!--/cq-->"), C2();
  const ie4 = a.resources.some((m) => m._cache !== 1 / 0);
  return { prefetchResources: void 0, snapshotResult: a, flushes: o, manifest: p2 == null ? void 0 : p2.manifest, size: r, isStatic: !ie4, timing: { render: T2, snapshot: R2, firstFlush: l2 }, _symbols: A2 };
}
function Fe2() {
...
function ne2(s) {
  if (s) {
    ...
    if (s = je2(s), s) {
      const e = {};
      return Object.entries(s.mapping).forEach(([n2, t]) => {
        e[N2(n2)] = [n2, t];
      }), { mapper: e, manifest: s };
    }
  }
}
var Le2 = (s) => s.replace(/<(\/?script)/gi, "\\x3C$1");
function We2(s, e) {
  var n2;
  for (const t of e) {
    const r = (n2 = t.$componentQrl$) == null ? void 0 : n2.getSymbol();
    r && !s.includes(r) && s.push(r);
  }
}
var Je2 = 'document["qFuncs_HASH"]=';
function Ve(s, e) {
  return Je2.replace("HASH", s) + `[${e.join(`,
`)}]`;
}
...
var Ke2 = () => {
  ...
  return le(je, { children: [qe("title", null, null, s.title, 1, null), qe("link", null, { rel: "canonical", href: j$((n2) => n2.url.href, [e], "p0.url.href") }, null, 3, null), qe("meta", null, { name: "viewport", content: "width=device-width, initial-scale=1.0" }, null, 3, null), qe("link", null, { rel: "icon", type: "image/svg+xml", href: "/favicon.svg" }, null, 3, null), s.meta.map((n2) => Oo("meta", { ...n2 }, null, 0, n2.key)), s.links.map((n2) => Oo("link", { ...n2 }, null, 0, n2.key)), s.styles.map((n2) => {
    var t;
    return Oo("style", { ...n2.props, ...(t = n2.props) != null && t.dangerouslySetInnerHTML ? {} : { dangerouslySetInnerHTML: n2.style } }, null, 0, n2.key);
  }), s.scripts.map((n2) => {
    var t;
    return Oo("script", { ...n2.props, ...(t = n2.props) != null && t.dangerouslySetInnerHTML ? {} : { dangerouslySetInnerHTML: n2.script } }, null, 0, n2.key);
  })] }, 1, "LU_0");
};
var $e2 = Kt(te(Ke2, "s_YxeVW9tHS3o"));
var Qe2 = () => (_i(), le(ol, { children: [qe("head", null, null, [qe("meta", null, { charset: "utf-8", name: "viewport", content: "width=device-width, initial-scale=1" }, null, 3, null), qe("link", null, { rel: "manifest", href: "/manifest.json" }, null, 3, "SD_0"), le($e2, null, 3, "SD_1")], 1, null), qe("body", null, { lang: "en" }, [le(sl, null, 3, "SD_2"), le(cl, null, 3, "SD_3")], 1, null)] }, 1, "SD_4"));
var He2 = Kt(te(Qe2, "s_6yoM2igDQNs"));
function Ze2(s) {
  return Be2(le(He2, null, 3, "t0_0"), { manifest: Ge2, ...s, containerAttributes: { lang: "en-us", ...s.containerAttributes }, serverData: { ...s.serverData } });
}
...
var ct2 = Kt(te(Bi2, "s_FlrIJWXb01g"));
var Fi2 = () => le(je, { children: [le(ct2, { href: "/", activeClass: "text-green-600", children: qe("h3", null, null, "Home", 3, null), [N]: { href: N, activeClass: N } }, 3, "pC_0"), le(ct2, { href: "/posts", activeClass: "text-green-600", children: qe("h3", null, null, "Posts", 3, null), [N]: { href: N, activeClass: N } }, 3, "pC_1")] }, 1, "pC_2");
var Ii2 = Kt(te(Fi2, "s_5V5T0WszXjY"));
var Di2 = async ({ cacheControl: r }) => {
...
var Mi2 = () => le(je, { children: [qe("header", null, null, le(Ii2, null, 3, "vF_0"), 1, null), qe("main", null, null, le(rt, null, 3, "vF_1"), 1, null), qe("footer", null, null, le(Pi2, null, 3, "vF_2"), 1, null)] }, 1, "vF_3");
var zi2 = Kt(te(Mi2, "s_sRiqT7AU2DM"));
var Ki2 = Object.freeze(Object.defineProperty({ __proto__: null, default: zi2, head: Ei2, onGet: Di2 }, Symbol.toStringTag, { value: "Module" }));
...
n(Ir2, St2, "ColumnBuilder");
var ue2 = Symbol.for("drizzle:Name");
var be3 = Symbol.for("drizzle:Schema");
var ht2 = Symbol.for("drizzle:Columns");
var dt2 = Symbol.for("drizzle:ExtraConfigColumns");
var De3 = Symbol.for("drizzle:OriginalName");
...
var Lt2;
var Ot2;
Ot2 = f, Lt2 = ue2, xt2 = De3, Tt2 = be3, qt2 = ht2, _t2 = dt2, Qt2 = Ee3, $t2 = ft2, Nt2 = Vi2, vt2 = mt2;
var p = class {
  constructor(t, e, s) {
    n(this, Lt2);
    n(this, xt2);
    ...
    n(this, Nt2, true);
    n(this, vt2);
    this[ue2] = this[De3] = t, this[be3] = e, this[Ee3] = s;
  }
};
n(p, Ot2, "Table"), n(p, "Symbol", { Name: ue2, Schema: be3, OriginalName: De3, Columns: ht2, ExtraConfigColumns: dt2, BaseName: Ee3, IsAlias: ft2, ExtraConfigBuilder: mt2 });
function ie2(r) {
  return r[ue2];
}
function ce2(r) {
  return `${r[be3] ?? "public"}.${r[ue2]}`;
}
...
var Rt2;
var At2;
var Ve2 = class extends (At2 = p, Rt2 = f, jt2 = pt2, Ct2 = p.Symbol.ExtraConfigBuilder, At2) {
  constructor() {
    super(...arguments);
    n(this, jt2, []);
    n(this, Ct2);
...
n(Ve2, Rt2, "PgTable"), n(Ve2, "Symbol", Object.assign({}, p.Symbol, { InlineForeignKeys: pt2 }));
...
var Bt2;
var Ft2;
var et2 = class extends (Ft2 = z2, Bt2 = f, Ft2) {
};
n(et2, Bt2, "WithSubquery");
var Wi2 = { startActiveSpan(r, t) {
  return t();
} };
var F2 = Symbol.for("drizzle:ViewBaseConfig");
function Dr2(r) {
...
var H2 = class H3 {
  ...
  buildQueryFromSourceParams(t, e) {
    ...
    return Ji2(t.map((c) => {
      ...
      if (Array.isArray(c)) {
        const y = [new R("(")];
        for (const [b, q3] of c.entries())
          y.push(q3), b < c.length - 1 && y.push(new R(", "));
      ...
      if (d(c, se3)) {
        const y = c[F2].schema, b = c[F2].name;
        return { sql: y === void 0 ? i(b) : i(y) + "." + i(b), params: [] };
      }
      if (d(c, J2)) {
        if (d(c.value, Z3))
      ...
      return d(c, Z3) ? { sql: a(h.value++, c), params: [c], typings: ["none"] } : d(c, H3.Aliased) && c.fieldAlias !== void 0 ? { sql: i(c.fieldAlias), params: [] } : d(c, z2) ? c._.isWith ? { sql: i(c._.alias), params: [] } : this.buildQueryFromSourceParams([new R("("), c._.sql, new R(") "), new ve3(c._.alias)], s) : Ui2(c) ? c.schema ? { sql: i(c.schema) + "." + i(c.enumName), params: [] } : { sql: i(c.enumName), params: [] } : Dr2(c) ? (m = c.shouldOmitSQLParens) != null && m.call(c) ? this.buildQueryFromSourceParams([c.getSQL()], s) : this.buildQueryFromSourceParams([new R("("), c.getSQL(), new R(")")], s) : o ? { sql: this.mapInlineParam(c, s), params: [] } : { sql: a(h.value++, c), params: [c], typings: ["none"] };
    }));
  }
  ...
  as(t) {
    return t === void 0 ? this : new H3.Aliased(this, t);
  }
  mapWith(t) {
...
var se3 = class {
  constructor({ name: t, schema: e, selectedFields: s, query: i }) {
    n(this, Kt2);
    this[F2] = { name: t, originalName: t, schema: e, selectedFields: s, query: i, isExisting: !i, isAlias: false };
  }
  getSQL() {
    return new g([this]);
  }
...
n(he2, Ut2, "ColumnAliasProxyHandler");
var Wt2;
Wt2 = f;
var Le3 = class {
  constructor(t, e) {
  ...
  get(t, e) {
    ...
    if (this.replaceOriginalName && e === p.Symbol.OriginalName)
      return this.alias;
    if (e === F2)
      return { ...t[F2], name: this.alias, isAlias: true };
    if (e === p.Symbol.Columns) {
      ...
      return Object.keys(i).map((u) => {
        a[u] = new Proxy(i[u], new he2(new Proxy(t, this)));
      }), a;
    }
    const s = t[e];
    return d(s, C) ? new Proxy(s, new he2(new Proxy(t, this))) : s;
  }
};
...
function U2(r, t) {
  return new Proxy(r, new he2(new Proxy(r.table, new Le3(t, false))));
}
function zr2(r, t) {
  return new g.Aliased(Ne3(r.sql, t), r.fieldAlias);
}
function Ne3(r, t) {
  return l.join(r.queryChunks.map((e) => d(e, C) ? U2(e, t) : d(e, g) ? Ne3(e, t) : d(e, g.Aliased) ? zr2(e, t) : e));
}
var Ue2 = Symbol.for("drizzle:SQLiteInlineForeignKeys");
var Jt2;
var Xt2;
var Yt2;
var Ht2;
var Gt2;
var B2 = class extends (Gt2 = p, Ht2 = f, Yt2 = p.Symbol.Columns, Xt2 = Ue2, Jt2 = p.Symbol.ExtraConfigBuilder, Gt2) {
  constructor() {
    super(...arguments);
    n(this, Yt2);
    n(this, Xt2, []);
...
n(B2, Ht2, "SQLiteTable"), n(B2, "Symbol", Object.assign({}, p.Symbol, { InlineForeignKeys: Ue2 }));
function Yi2(r, t, e, s, i = r) {
  const a = new B2(r, s, i), u = Object.fromEntries(Object.entries(t).map(([h, c]) => {
    const m = c, y = m.build(a);
    return a[Ue2].push(...m.buildForeignKeys(y, a)), [h, y];
  })), o = Object.assign(a, u);
...
n(Vr, Zt2, "SQLiteForeignKeyBuilder");
var kt2;
kt2 = f;
var Ur2 = class {
  constructor(t, e) {
  ...
  getName() {
    const { name: t, columns: e, foreignColumns: s } = this.reference(), i = e.map((o) => o.name), a = s.map((o) => o.name), u = [this.table[B2.Symbol.Name], ...i, s[0].table[B2.Symbol.Name], ...a];
    return t ?? `${u.join("_")}_fk`;
  }
};
n(Ur2, kt2, "SQLiteForeignKey");
function Hi2(r, t) {
  return `${r[B2.Symbol.Name]}_${t.join("_")}_unique`;
}
var es2;
var ts2;
var Oe3 = class extends (ts2 = Ir2, es2 = f, ts2) {
  constructor() {
    super(...arguments);
...
var ss2;
var rs2;
var G2 = class extends (rs2 = C, ss2 = f, rs2) {
  constructor(t, e) {
    e.uniqueName || (e.uniqueName = Hi2(t, [e.name])), super(t, e), this.table = t;
  }
};
n(G2, ss2, "SQLiteColumn");
var is2;
var ns2;
var Ce3 = class extends (ns2 = Oe3, is2 = f, ns2) {
  constructor(t, e, s) {
...
n(Ce3, is2, "SQLiteBaseIntegerBuilder");
var as2;
var os2;
var je3 = class extends (os2 = G2, as2 = f, os2) {
  constructor() {
    super(...arguments);
...
n(je3, as2, "SQLiteBaseInteger");
var ls2;
var us2;
var Wr2 = class extends (us2 = Ce3, ls2 = f, us2) {
  constructor(t) {
...
n(Wr2, ls2, "SQLiteIntegerBuilder");
var cs2;
var hs2;
var Jr = class extends (hs2 = je3, cs2 = f, hs2) {
};
n(Jr, cs2, "SQLiteInteger");
var ds2;
var fs2;
var Xr2 = class extends (fs2 = Ce3, ds2 = f, fs2) {
  constructor(t, e) {
...
var ms2;
var ps2;
var Yr2 = class extends (ps2 = je3, ms2 = f, ps2) {
  constructor() {
    super(...arguments);
...
var ys2;
var gs2;
var Hr2 = class extends (gs2 = Ce3, ys2 = f, gs2) {
  constructor(t, e) {
    super(t, "boolean", "SQLiteBoolean"), this.config.mode = e;
  }
  build(t) {
    return new Gr2(t, this.config);
  }
};
n(Hr2, ys2, "SQLiteBooleanBuilder");
var bs2;
var ws2;
var Gr2 = class extends (ws2 = je3, bs2 = f, ws2) {
  constructor() {
    super(...arguments);
    n(this, "mode", this.config.mode);
  }
...
n(Gr2, bs2, "SQLiteBoolean");
function we2(r, t) {
  return (t == null ? void 0 : t.mode) === "timestamp" || (t == null ? void 0 : t.mode) === "timestamp_ms" ? new Xr2(r, t.mode) : (t == null ? void 0 : t.mode) === "boolean" ? new Hr2(r, t.mode) : new Wr2(r);
}
var Ss2;
var vs2;
var Zr2 = class extends (vs2 = Oe3, Ss2 = f, vs2) {
  constructor(t, e) {
    super(t, "string", "SQLiteText"), this.config.enumValues = e.enum, this.config.length = e.length;
  }
  build(t) {
    return new kr2(t, this.config);
  }
};
n(Zr2, Ss2, "SQLiteTextBuilder");
var Ns2;
var $s2;
var kr2 = class extends ($s2 = G2, Ns2 = f, $s2) {
  constructor(e, s) {
    super(e, s);
...
n(kr2, Ns2, "SQLiteText");
var Qs2;
var _s2;
var ei2 = class extends (_s2 = Oe3, Qs2 = f, _s2) {
  constructor(t) {
...
n(ei2, Qs2, "SQLiteTextJsonBuilder");
var qs2;
var Ts2;
var ti2 = class extends (Ts2 = G2, qs2 = f, Ts2) {
  getSQLType() {
    return "text";
  }
  mapFromDriverValue(t) {
...
function Se3(r, t = {}) {
  return t.mode === "json" ? new ei2(r) : new Zr2(r, t);
}
var xs2;
xs2 = f;
var _e2 = class _e3 {
  ...
  get(t, e) {
    ...
    if (e === F2)
      return { ...t[F2], selectedFields: new Proxy(t[F2].selectedFields, this) };
    if (typeof e == "symbol")
      return t[e];
    const i = (d(t, z2) ? t._.selectedFields : d(t, se3) ? t[F2].selectedFields : t)[e];
    if (d(i, g.Aliased)) {
    ...
    return d(i, C) ? this.config.alias ? new Proxy(i, new he2(new Proxy(i.table, new Le3(this.config.alias, this.config.replaceOriginalName ?? false)))) : i : typeof i != "object" || i === null ? i : new Proxy(i, new _e3(this.config));
  }
};
n(_e2, xs2, "SelectionProxyHandler");
var M3 = _e2;
var Ls2;
var Os2;
...
function ze3(r, t, e) {
  const s = {}, i = r.reduce((a, { path: u, field: o }, h) => {
    let c;
    d(o, C) ? c = o : d(o, g) ? c = o.decoder : c = o.sql.decoder;
    let m = a;
    for (const [y, b] of u.entries())
      if (y < u.length - 1)
        b in m || (m[b] = {}), m = m[b];
      else {
        const q3 = t[h], v2 = m[b] = q3 === null ? null : c.mapFromDriverValue(q3);
        if (e && d(o, C) && u.length === 2) {
          const $ = u[0];
          $ in s ? typeof s[$] == "string" && s[$] !== ie2(o.table) && (s[$] = false) : s[$] = v2 === null ? ie2(o.table) : false;
        }
      }
    return a;
  }, {});
...
function k2(r, t) {
  return Object.entries(r).reduce((e, [s, i]) => {
    if (typeof s != "string")
      return e;
    const a = t ? [...t, s] : [s];
    return d(i, C) || d(i, g) || d(i, g.Aliased) ? e.push({ path: a, field: i }) : d(i, p) ? e.push(...k2(i[p.Symbol.Columns], a)) : e.push(...k2(i, a)), e;
  }, []);
}
function si2(r, t) {
...
function ri2(r, t) {
  const e = Object.entries(t).filter(([, s]) => s !== void 0).map(([s, i]) => d(i, g) ? [s, i] : [s, new J2(i, r[p.Symbol.Columns][s])]);
  if (e.length === 0)
...
function gt2(r) {
  return d(r, z2) ? r._.alias : d(r, se3) ? r[F2].name : d(r, g) ? void 0 : r[p.Symbol.IsAlias] ? r[p.Symbol.Name] : r[p.Symbol.BaseName];
}
var Cs2;
var js2;
var We3 = class extends (js2 = Y2, Cs2 = f, js2) {
  constructor(e, s, i, a) {
    super();
    n(this, "config");
  ...
  returning(e = this.table[B2.Symbol.Columns]) {
    return this.config.returning = k2(e), this;
  }
  getSQL() {
...
var ii2 = class extends (Ps2 = Y2, As2 = f, Ps2) {
  ...
  returning(e = this.config.table[B2.Symbol.Columns]) {
    return this.config.returning = k2(e), this;
  }
...
var Bs2;
var Fs2;
var Re2 = class extends (Fs2 = Error, Bs2 = f, Fs2) {
  constructor({ message: t, cause: e }) {
    super(t), this.name = "DrizzleError", this.cause = e;
  }
};
n(Re2, Bs2, "DrizzleError");
var Is2;
var Ds2;
var ni2 = class extends (Ds2 = Re2, Is2 = f, Ds2) {
  constructor() {
    super({ message: "Rollback" });
  }
};
n(ni2, Is2, "TransactionRollbackError");
var Es2;
Es2 = f;
var ai2 = class {
  constructor(t, e) {
  ...
  build(t) {
    return new oi2(t, this.columns, this.name);
  }
};
...
var oi2 = class {
  ...
  getName() {
    return this.name ?? `${this.table[Ve2.Symbol.Name]}_${this.columns.map((t) => t.name).join("_")}_pk`;
  }
};
n(oi2, Ms2, "PgPrimaryKey");
function I(r, t) {
  return Xi2(t) && !Dr2(r) && !d(r, J2) && !d(r, Z3) && !d(r, C) && !d(r, p) && !d(r, se3) ? new J2(r, t) : r;
}
var li2 = (r, t) => l`${r} = ${I(t, r)}`;
var ki2 = (r, t) => l`${r} <> ${I(t, r)}`;
function Xe3(...r) {
  const t = r.filter((e) => e !== void 0);
  if (t.length !== 0)
    return t.length === 1 ? new g(t) : new g([new R("("), l.join(t, new R(" and ")), new R(")")]);
}
function en2(...r) {
  const t = r.filter((e) => e !== void 0);
  if (t.length !== 0)
    return t.length === 1 ? new g(t) : new g([new R("("), l.join(t, new R(" or ")), new R(")")]);
}
function tn2(r) {
  return l`not ${r}`;
}
var sn2 = (r, t) => l`${r} > ${I(t, r)}`;
var rn2 = (r, t) => l`${r} >= ${I(t, r)}`;
var nn2 = (r, t) => l`${r} < ${I(t, r)}`;
var an2 = (r, t) => l`${r} <= ${I(t, r)}`;
function on2(r, t) {
  return Array.isArray(t) ? t.length === 0 ? l`false` : l`${r} in ${t.map((e) => I(e, r))}` : l`${r} in ${I(t, r)}`;
}
function ln2(r, t) {
  return Array.isArray(t) ? t.length === 0 ? l`true` : l`${r} not in ${t.map((e) => I(e, r))}` : l`${r} not in ${I(t, r)}`;
}
function un2(r) {
  return l`${r} is null`;
}
...
function fn2(r, t, e) {
  return l`${r} between ${I(t, r)} and ${I(e, r)}`;
}
function mn2(r, t, e) {
  return l`${r} not between ${I(t, r)} and ${I(e, r)}`;
}
function pn2(r, t) {
  return l`${r} like ${t}`;
}
...
var Vs2;
var Us2;
var qe2 = class qe3 extends (Us2 = tt2, Vs2 = f, Us2) {
  constructor(t, e, s, i) {
...
var Ws2;
var Js2;
var Te3 = class Te4 extends (Js2 = tt2, Ws2 = f, Js2) {
  constructor(t, e, s) {
...
var $e3 = Te3;
function vn2() {
  return { and: Xe3, between: fn2, eq: li2, exists: hn2, gt: sn2, gte: rn2, ilike: gn2, inArray: on2, isNull: un2, isNotNull: cn2, like: pn2, lt: nn2, lte: an2, ne: ki2, not: tn2, notBetween: mn2, notExists: dn2, notLike: yn2, notIlike: bn2, notInArray: ln2, or: en2, sql: l };
}
function Nn2() {
...
function $n2(r, t) {
  ...
  for (const [u, o] of Object.entries(r))
    if (d(o, p)) {
      ...
      const h = ce2(o.table), c = e[h], m = o.config(t(o.table));
      let y;
      for (const [b, q3] of Object.entries(m))
        if (c) {
          const v2 = i[c];
          v2.relations[b] = q3;
        } else
          h in s || (s[h] = { relations: {}, primaryKey: y }), s[h].relations[b] = q3;
    }
  return { tables: i, tableNamesMap: e };
}
function ui2(r, t) {
  return new st2(r, (e) => Object.fromEntries(Object.entries(t(e)).map(([s, i]) => [s, i.withFieldName(s)])));
}
function Qn2(r) {
  return function(e, s) {
...
function Tn2(r) {
  return { one: Qn2(r), many: _n2(r) };
}
function Ye2(r, t, e, s, i = (a) => a) {
  const a = {};
  for (const [u, o] of s.entries())
    if (o.isJson) {
      const h = t.relations[o.tsKey], c = e[u], m = typeof c == "string" ? JSON.parse(c) : c;
      a[o.tsKey] = d(h, ee3) ? m && Ye2(r, r[o.relationTableTsKey], m, o.selection, i) : m.map((y) => Ye2(r, r[o.relationTableTsKey], y, o.selection, i));
    } else {
      const h = i(e[u]), c = o.field;
      let m;
      d(c, C) ? m = c : d(c, g) ? m = c.decoder : m = c.sql.decoder, a[o.tsKey] = h === null ? null : m.mapFromDriverValue(h);
    }
  return a;
}
var Xs2;
var Ys2;
var rt2 = class extends (Ys2 = se3, Xs2 = f, Ys2) {
};
n(rt2, Xs2, "SQLiteViewBase");
var Hs2;
Hs2 = f;
var it2 = class {
  escapeName(t) {
  ...
  buildSelection(t, { isSingleTable: e = false } = {}) {
    const s = t.length, i = t.flatMap(({ field: a }, u) => {
      const o = [];
      if (d(a, g.Aliased) && a.isSelectionField)
        o.push(l.identifier(a.fieldAlias));
      else if (d(a, g.Aliased) || d(a, g)) {
        const h = d(a, g.Aliased) ? a.sql : a;
        e ? o.push(new g(h.queryChunks.map((c) => d(c, C) ? l.identifier(c.name) : c))) : o.push(h), d(a, g.Aliased) && o.push(l` as ${l.identifier(a.fieldAlias)}`);
      } else if (d(a, C)) {
  ...
  buildSelectQuery({ withList: t, fields: e, fieldsFlat: s, where: i, having: a, table: u, joins: o, orderBy: h, groupBy: c, limit: m, offset: y, distinct: b, setOperators: q3 }) {
    const v2 = s ?? k2(e);
    for (const A2 of v2)
      if (d(A2.field, C) && ie2(A2.field.table) !== (d(u, z2) ? u._.alias : d(u, rt2) ? u[F2].name : d(u, g) ? void 0 : ie2(u)) && !((O3) => o == null ? void 0 : o.some(({ alias: V2 }) => V2 === (O3[p.Symbol.IsAlias] ? ie2(O3) : O3[p.Symbol.BaseName])))(A2.field.table)) {
    ...
    const $ = !o || o.length === 0, x2 = this.buildWithCTE(t), L3 = b ? l` distinct` : void 0, Q3 = this.buildSelection(v2, { isSingleTable: $ }), j4 = d(u, p) && u[p.Symbol.OriginalName] !== u[p.Symbol.Name] ? l`${l.identifier(u[p.Symbol.OriginalName])} ${l.identifier(u[p.Symbol.Name])}` : u, N3 = [];
    if (o)
      for (const [A2, O3] of o.entries()) {
        A2 === 0 && N3.push(l` `);
        const V2 = O3.table;
        if (d(V2, B2)) {
          const Ie3 = V2[B2.Symbol.Name], ot3 = V2[B2.Symbol.Schema], lt3 = V2[B2.Symbol.OriginalName], ut3 = Ie3 === lt3 ? void 0 : O3.alias;
          N3.push(l`${l.raw(O3.joinType)} join ${ot3 ? l`${l.identifier(ot3)}.` : void 0}${l.identifier(lt3)}${ut3 && l` ${l.identifier(ut3)}`} on ${O3.on}`);
        } else
          N3.push(l`${l.raw(O3.joinType)} join ${V2} on ${O3.on}`);
        A2 < o.length - 1 && N3.push(l` `);
      }
    const D3 = l.join(N3), re3 = i ? l` where ${i}` : void 0, w = a ? l` having ${a}` : void 0, S2 = [];
    if (h)
    ...
    const fe3 = P2.length > 0 ? l` group by ${l.join(P2)}` : void 0, Fe4 = S2.length > 0 ? l` order by ${l.join(S2)}` : void 0, oe2 = typeof m == "object" || typeof m == "number" && m >= 0 ? l` limit ${m}` : void 0, me3 = y ? l` offset ${y}` : void 0, pe3 = l`${x2}select${L3} ${Q3} from ${j4}${D3}${re3}${fe3}${w}${Fe4}${oe2}${me3}`;
    return q3.length > 0 ? this.buildSetOperations(pe3, q3) : pe3;
  }
  ...
  buildSetOperationQuery({ leftSelect: t, setOperator: { type: e, isAll: s, rightSelect: i, limit: a, orderBy: u, offset: o } }) {
    ...
    if (u && u.length > 0) {
      ...
      for (const $ of u)
        if (d($, G2))
          v2.push(l.identifier($.name));
        else if (d($, g)) {
          for (let x2 = 0; x2 < $.queryChunks.length; x2++) {
            const L3 = $.queryChunks[x2];
            d(L3, G2) && ($.queryChunks[x2] = l.identifier(L3.name));
          }
          v2.push(l`${$}`);
        } else
          v2.push(l`${$}`);
      m = l` order by ${l.join(v2, l`, `)}`;
    }
    const y = typeof a == "object" || typeof a == "number" && a >= 0 ? l` limit ${a}` : void 0, b = l.raw(`${e} ${s ? "all " : ""}`), q3 = o ? l` offset ${o}` : void 0;
    return l`${h}${b}${c}${m}${y}${q3}`;
  }
  buildInsertQuery({ table: t, values: e, onConflict: s, returning: i, withList: a }) {
    const u = [], o = t[p.Symbol.Columns], h = Object.entries(o).filter(([v2, $]) => !$.shouldDisableInsert()), c = h.map(([, v2]) => l.identifier(v2.name));
    for (const [v2, $] of e.entries()) {
      const x2 = [];
      for (const [L3, Q3] of h) {
        const j4 = $[L3];
        if (j4 === void 0 || d(j4, J2) && j4.value === void 0) {
          let N3;
          if (Q3.default !== null && Q3.default !== void 0)
            N3 = d(Q3.default, g) ? Q3.default : l.param(Q3.default, Q3);
          else if (Q3.defaultFn !== void 0) {
            const D3 = Q3.defaultFn();
            N3 = d(D3, g) ? D3 : l.param(D3, Q3);
          } else if (!Q3.default && Q3.onUpdateFn !== void 0) {
            const D3 = Q3.onUpdateFn();
            N3 = d(D3, g) ? D3 : l.param(D3, Q3);
          } else
            N3 = l`null`;
          x2.push(N3);
      ...
      u.push(x2), v2 < e.length - 1 && u.push(l`, `);
    }
    const m = this.buildWithCTE(a), y = l.join(u), b = i ? l` returning ${this.buildSelection(i, { isSingleTable: true })}` : void 0, q3 = s ? l` on conflict ${s}` : void 0;
    return l`${m}insert into ${t} ${c} values ${y}${q3}${b}`;
  }
  sqlToQuery(t, e) {
  ...
  buildRelationalQuery({ fullSchema: t, schema: e, tableNamesMap: s, table: i, tableConfig: a, queryConfig: u, tableAlias: o, nestedQueryRelation: h, joinOn: c }) {
    ...
    const $ = [];
    if (u === true)
      m = Object.entries(a.columns).map(([Q3, j4]) => ({ dbKey: j4.name, tsKey: Q3, field: U2(j4, o), relationTableTsKey: void 0, isJson: false, selection: [] }));
    else {
      ...
      if (u.columns) {
        ...
        for (const [S2, P2] of Object.entries(u.columns))
          P2 !== void 0 && S2 in a.columns && (!w && P2 === true && (w = true), j4.push(S2));
        j4.length > 0 && (j4 = w ? j4.filter((S2) => {
          var P2;
          return ((P2 = u.columns) == null ? void 0 : P2[S2]) === true;
        }) : Object.keys(a.columns).filter((S2) => !j4.includes(S2)));
      } else
        j4 = Object.keys(a.columns);
      for (const w of j4) {
        const S2 = a.columns[w];
        Q3.push({ tsKey: w, value: S2 });
      }
      let N3 = [];
      u.with && (N3 = Object.entries(u.with).filter((w) => !!w[1]).map(([w, S2]) => ({ tsKey: w, queryConfig: S2, relation: a.relations[w] })));
      let D3;
      if (u.extras) {
        D3 = typeof u.extras == "function" ? u.extras(L3, { sql: l }) : u.extras;
        for (const [w, S2] of Object.entries(D3))
          Q3.push({ tsKey: w, value: zr2(S2, o) });
      }
      for (const { tsKey: w, value: S2 } of Q3)
        m.push({ dbKey: d(S2, g.Aliased) ? S2.fieldAlias : a.columns[w].name, tsKey: w, field: d(S2, C) ? U2(S2, o) : S2, relationTableTsKey: void 0, isJson: false, selection: [] });
      let re3 = typeof u.orderBy == "function" ? u.orderBy(L3, Nn2()) : u.orderBy ?? [];
      Array.isArray(re3) || (re3 = [re3]), q3 = re3.map((w) => d(w, C) ? U2(w, o) : Ne3(w, o)), y = u.limit, b = u.offset;
      for (const { tsKey: w, queryConfig: S2, relation: P2 } of N3) {
        const fe3 = qn2(e, s, P2), Fe4 = ce2(P2.referencedTable), oe2 = s[Fe4], me3 = `${o}_${w}`, pe3 = Xe3(...fe3.fields.map((V2, Ie3) => li2(U2(fe3.references[Ie3], me3), U2(V2, o)))), A2 = this.buildRelationalQuery({ fullSchema: t, schema: e, tableNamesMap: s, table: t[oe2], tableConfig: e[oe2], queryConfig: d(P2, ee3) ? S2 === true ? { limit: 1 } : { ...S2, limit: 1 } : S2, tableAlias: me3, joinOn: pe3, nestedQueryRelation: P2 }), O3 = l`(${A2.sql})`.as(w);
    ...
    let x2;
    if (v2 = Xe3(c, v2), h) {
      let L3 = l`json_array(${l.join(m.map(({ field: N3 }) => d(N3, G2) ? l.identifier(N3.name) : d(N3, g.Aliased) ? N3.sql : N3), l`, `)})`;
      d(h, $e3) && (L3 = l`coalesce(json_group_array(${L3}), json_array())`);
      const Q3 = [{ dbKey: "data", tsKey: "data", field: L3.as("data"), isJson: true, relationTableTsKey: a.tsName, selection: m }];
      y !== void 0 || b !== void 0 || q3.length > 0 ? (x2 = this.buildSelectQuery({ table: Me2(i, o), fields: {}, fieldsFlat: [{ path: [], field: l.raw("*") }], where: v2, limit: y, offset: b, orderBy: q3, setOperators: [] }), v2 = void 0, y = void 0, b = void 0, q3 = void 0) : x2 = Me2(i, o), x2 = this.buildSelectQuery({ table: d(x2, B2) ? x2 : new z2(x2, {}, o), fields: {}, fieldsFlat: Q3.map(({ field: N3 }) => ({ path: [], field: d(N3, C) ? U2(N3, o) : N3 })), joins: $, where: v2, limit: y, offset: b, orderBy: q3, setOperators: [] });
    } else
      x2 = this.buildSelectQuery({ table: Me2(i, o), fields: {}, fieldsFlat: m.map(({ field: L3 }) => ({ path: [], field: d(L3, C) ? U2(L3, o) : L3 })), joins: $, where: v2, limit: y, offset: b, orderBy: q3, setOperators: [] });
    return { tableTsKey: a.tsName, sql: x2, selection: m };
  }
};
n(it2, Hs2, "SQLiteDialect");
var Gs2;
var Zs2;
var ci2 = class extends (Zs2 = it2, Gs2 = f, Zs2) {
  migrate(t, e, s) {
...
n(ci2, Gs2, "SQLiteSyncDialect");
var ks2;
var er2;
var hi2 = class extends (er2 = it2, ks2 = f, er2) {
  async migrate(t, e, s) {
    const i = s === void 0 || typeof s == "string" ? "__drizzle_migrations" : s.migrationsTable ?? "__drizzle_migrations", a = l`
			CREATE TABLE IF NOT EXISTS ${l.identifier(i)} (
				id SERIAL PRIMARY KEY,
...
var W2 = class {
  ...
  from(t) {
    const e = !!this.fields;
    let s;
    return this.fields ? s = this.fields : d(t, z2) ? s = Object.fromEntries(Object.keys(t._.selectedFields).map((i) => [i, t[i]])) : d(t, rt2) ? s = t[F2].selectedFields : d(t, g) ? s = {} : s = Zi2(t), new nt2({ table: t, fields: s, isPartialSelect: e, session: this.session, dialect: this.dialect, withList: this.withList, distinct: this.distinct });
  }
};
...
var fi2 = class extends (ir2 = di2, rr2 = f, ir2) {
  ...
  createJoin(e) {
    return (s, i) => {
      ...
      if (!this.isPartialSelect && (Object.keys(this.joinsNotNullableMap).length === 1 && typeof a == "string" && (this.config.fields = { [a]: this.config.fields }), typeof u == "string" && !d(s, g))) {
        const h = d(s, z2) ? s._.selectedFields : d(s, se3) ? s[F2].selectedFields : s[p.Symbol.Columns];
        this.config.fields[u] = h;
      }
      if (typeof i == "function" && (i = i(new Proxy(this.config.fields, new M3({ sqlAliasedBehavior: "sql", sqlBehavior: "sql" })))), this.config.joins || (this.config.joins = []), this.config.joins.push({ on: i, table: s, joinType: e, alias: u }), typeof u == "string")
        switch (e) {
          case "left": {
  ...
  where(e) {
    return typeof e == "function" && (e = e(new Proxy(this.config.fields, new M3({ sqlAliasedBehavior: "sql", sqlBehavior: "sql" })))), this.config.where = e, this;
  }
  having(e) {
    return typeof e == "function" && (e = e(new Proxy(this.config.fields, new M3({ sqlAliasedBehavior: "sql", sqlBehavior: "sql" })))), this.config.having = e, this;
  }
  groupBy(...e) {
    if (typeof e[0] == "function") {
      const s = e[0](new Proxy(this.config.fields, new M3({ sqlAliasedBehavior: "alias", sqlBehavior: "sql" })));
  ...
  orderBy(...e) {
    if (typeof e[0] == "function") {
      const s = e[0](new Proxy(this.config.fields, new M3({ sqlAliasedBehavior: "alias", sqlBehavior: "sql" }))), i = Array.isArray(s) ? s : [s];
  ...
  as(e) {
    return new Proxy(new z2(this.getSQL(), this.config.fields, e), new M3({ alias: e, sqlAliasedBehavior: "alias", sqlBehavior: "error" }));
  }
  getSelectedFields() {
    return new Proxy(this.config.fields, new M3({ alias: this.tableName, sqlAliasedBehavior: "alias", sqlBehavior: "error" }));
  }
  $dynamic() {
    return this;
  }
...
var nr2;
var ar2;
var nt2 = class extends (ar2 = fi2, nr2 = f, ar2) {
  constructor() {
    super(...arguments);
  ...
  _prepare(e = true) {
    ...
    const s = k2(this.config.fields), i = this.session[e ? "prepareOneTimeQuery" : "prepareQuery"](this.dialect.sqlToQuery(this.getSQL()), s, "all", true);
...
var xn2 = () => ({ union: Ln2, unionAll: On2, intersect: Cn2, except: jn2 });
var Ln2 = Ae3("union", false);
var On2 = Ae3("union", true);
var Cn2 = Ae3("intersect", false);
var jn2 = Ae3("except", false);
var or2;
or2 = f;
var Pe3 = class {
  constructor() {
  ...
  $with(t) {
    const e = this;
    return { as(s) {
      return typeof s == "function" && (s = s(e)), new Proxy(new et2(s.getSQL(), s.getSelectedFields(), t, true), new M3({ alias: t, sqlAliasedBehavior: "alias", sqlBehavior: "error" }));
    } };
  }
  with(...t) {
    const e = this;
...
var pi2 = class {
  ...
  findMany(t) {
    return this.mode === "sync" ? new Ge3(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, t || {}, "many") : new Qe3(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, t || {}, "many");
  }
  findFirst(t) {
    return this.mode === "sync" ? new Ge3(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, t ? { ...t, limit: 1 } : { limit: 1 }, "first") : new Qe3(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, t ? { ...t, limit: 1 } : { limit: 1 }, "first");
  }
};
n(pi2, hr2, "SQLiteAsyncRelationalQueryBuilder");
var dr2;
var fr2;
var Qe3 = class extends (fr2 = Y2, dr2 = f, fr2) {
  ...
  _prepare(e = false) {
    ...
    return this.session[e ? "prepareOneTimeQuery" : "prepareQuery"](i, void 0, this.mode === "first" ? "get" : "all", true, (a, u) => {
      const o = a.map((h) => Ye2(this.schema, this.tableConfig, h, s.selection, u));
...
n(Qe3, dr2, "SQLiteAsyncRelationalQuery");
var mr2;
var pr2;
var Ge3 = class extends (pr2 = Qe3, mr2 = f, pr2) {
  sync() {
    return this.executeRaw();
  }
};
n(Ge3, mr2, "SQLiteSyncRelationalQuery");
var yr2;
var gr2;
var le2 = class extends (gr2 = Y2, yr2 = f, gr2) {
  constructor(e, s, i, a, u) {
    super();
    n(this, "config");
...
var at2 = class {
  ...
  $with(t) {
    return { as(e) {
      return typeof e == "function" && (e = e(new Pe3())), new Proxy(new et2(e.getSQL(), e.getSelectedFields(), t, true), new M3({ alias: t, sqlAliasedBehavior: "alias", sqlBehavior: "error" }));
    } };
  }
  with(...t) {
    const e = this;
    ...
    function a(h) {
      return new He3(h, e.session, e.dialect, t);
    }
    function u(h) {
      return new Je3(h, e.session, e.dialect, t);
    }
    function o(h) {
      return new We3(h, e.session, e.dialect, t);
    }
  ...
  update(t) {
    return new He3(t, this.session, this.dialect);
  }
  insert(t) {
    return new Je3(t, this.session, this.dialect);
  }
  delete(t) {
    return new We3(t, this.session, this.dialect);
  }
  run(t) {
    const e = t.getSQL();
    return this.resultKind === "async" ? new le2(async () => this.session.run(e), () => e, "run", this.dialect, this.session.extractRawRunValueFromBatchResult.bind(this.session)) : this.session.run(e);
  }
  all(t) {
    const e = t.getSQL();
    return this.resultKind === "async" ? new le2(async () => this.session.all(e), () => e, "all", this.dialect, this.session.extractRawAllValueFromBatchResult.bind(this.session)) : this.session.all(e);
  }
  get(t) {
    const e = t.getSQL();
    return this.resultKind === "async" ? new le2(async () => this.session.get(e), () => e, "get", this.dialect, this.session.extractRawGetValueFromBatchResult.bind(this.session)) : this.session.get(e);
  }
  values(t) {
    const e = t.getSQL();
    return this.resultKind === "async" ? new le2(async () => this.session.values(e), () => e, "values", this.dialect, this.session.extractRawValuesValueFromBatchResult.bind(this.session)) : this.session.values(e);
  }
  transaction(t, e) {
    return this.session.transaction(t, e);
  }
};
n(at2, br2, "BaseSQLiteDatabase");
var wr2;
var Sr2;
...
var $r2;
var Qr2;
var wi2 = class extends (Qr2 = at2, $r2 = f, Qr2) {
...
var xr2;
var Lr2;
var $i2 = class extends (Lr2 = bi2, xr2 = f, Lr2) {
  constructor(e, s, i, a = {}) {
    super(s);
    n(this, "logger");
  ...
  prepareQuery(e, s, i, a, u) {
    ...
    return new Qi2(o, e, this.logger, s, i, a, u);
  }
  async batch(e) {
    const s = [], i = [];
    for (const u of e) {
...
n($i2, xr2, "SQLiteD1Session");
var Or2;
var Cr2;
var xe3 = class xe4 extends (Cr2 = wi2, Or2 = f, Cr2) {
  async transaction(t) {
...
var jr2;
var Rr2;
var Qi2 = class extends (Rr2 = gi2, jr2 = f, Rr2) {
  ...
  run(e) {
    const s = ye3(this.query.params, e ?? {});
  ...
  mapAllResult(e, s) {
    return s && (e = ke3(e.results)), !this.fields && !this.customResultMapper ? e : this.customResultMapper ? this.customResultMapper(e) : e.map((i) => ze3(this.fields, i, this.joinsNotNullableMap));
  }
  async get(e) {
    const { fields: s, joinsNotNullableMap: i, query: a, logger: u, stmt: o, customResultMapper: h } = this;
    if (!s && !h) {
      const m = ye3(a.params, e ?? {});
  ...
  mapGetResult(e, s) {
    return s && (e = ke3(e.results)[0]), !this.fields && !this.customResultMapper ? e : this.customResultMapper ? this.customResultMapper([e]) : ze3(this.fields, e, this.joinsNotNullableMap);
  }
  values(e) {
    const s = ye3(this.query.params, e ?? {});
...
n(Qi2, jr2, "D1PreparedQuery");
var Ar2;
var Pr2;
var _i2 = class extends (Pr2 = at2, Ar2 = f, Pr2) {
  async batch(t) {
...
var ne3 = Kr2("users", { ...qi2, username: Se3("username") });
var de2 = Kr2("posts", { ...qi2, authorId: we2("author_id").notNull().references(() => ne3.id), title: Se3("title").notNull(), description: Se3("description").notNull(), content: Se3("content").notNull() });
var An2 = ui2(ne3, ({ many: r }) => ({ posts: r(de2) }));
var Pn2 = ui2(de2, ({ one: r }) => ({ author: r(ne3, { fields: [de2.authorId], references: [ne3.id] }) }));
var Bn2 = Object.freeze(Object.defineProperty({ __proto__: null, posts: de2, postsRelations: Pn2, users: ne3, usersRelations: An2 }, Symbol.toStringTag, { value: "Module" }));
var Fn2 = () => {
};
var In2 = (r) => r.env.get("D1") ? r.env.get("D1") : Fn2();
var Dn2 = "Invariant failed";
function En2(r, t) {
  if (!r)
    throw new Error(Dn2);
}
var Mn2 = new Pe3().select().from(de2).$dynamic();
var zn2 = new Pe3().select().from(ne3).$dynamic();
var Kn2 = /* @__PURE__ */ new Map([["posts", Mn2], ["users", zn2]]);
var Vn2 = el(async function(r) {
  const t = Rn2(await In2(this), { schema: Bn2 }), e = Kn2.get(r);
  En2(e);
  const i = ((u) => {
    const { searchParams: o } = new URL(this.platform.request.url), h = Number(o.get("limit")) || void 0, c = Number(o.get("offset")) || void 0;
    return h && c ? u.offset(c).limit(h) : u;
  })(e);
  return t.run(i);
}, "7QwFqO9aXtA");
var Be3 = $l(te(Vn2, "s_7QwFqO9aXtA"));
var Un2 = () => {
  const r = Be3("posts");
  return le(je, { children: le(tl, { value: r, onResolved: (t) => t.results.flat().reduce((e, s) => (_i(), "title" in s ? [...e, qe("div", null, null, [le(il, { href: s.id.toString(), children: [qe("h1", null, null, Ii(s, "title"), 1, null), qe("h2", null, null, Ii(s, "authorId"), 1, null), qe("h3", null, null, ["ID (DESCRIPTION)", Ii(s, "id")], 1, null)] }, 1, "xL_0"), le(rt, null, 3, "xL_1")], 1, "xL_2")] : e), []), [N]: { value: N, onResolved: N } }, 3, "xL_3") }, 1, "xL_4");
};
var Wn2 = Kt(te(Un2, "s_o4AHZqJ7TC4"));
var Jn2 = Object.freeze(Object.defineProperty({ __proto__: null, default: Wn2, useQuery: Be3 }, Symbol.toStringTag, { value: "Module" }));
var Xn2 = () => {
  const r = Be3("posts");
  return le(je, { children: [le(tl, { value: r, onResolved: (t) => t.results.flat().reduce((e, s) => "title" in s ? [...e, qe("p", null, null, Ii(s, "content"), 1, "ws_0")] : e, []), [N]: { value: N, onResolved: N } }, 3, "ws_1"), le(rt, null, 3, "ws_2")] }, 1, "ws_3");
};
var Yn = Kt(te(Xn2, "s_rnfws6KWrXc"));
var Hn2 = Object.freeze(Object.defineProperty({ __proto__: null, default: Yn, useQuery: Be3 }, Symbol.toStringTag, { value: "Module" }));
var Gn2 = () => le(je, { children: [qe("h1", null, null, "welcome\u2728", 3, null), qe("h2", null, null, "thank you for visiting my website", 3, null), qe("br", null, null, null, 3, null), qe("p", null, null, ["hi, this place is under construction right now!", qe("br", null, null, null, 3, null), "please bookmark this page \u{1F408}"], 3, null), qe("script", null, null, null, 3, null)] }, 3, "RI_0");
var Zn2 = Kt(te(Gn2, "s_29R7P00OKFA"));
var kn2 = Object.freeze(Object.defineProperty({ __proto__: null, default: Zn2 }, Symbol.toStringTag, { value: "Module" }));
...
var bt2 = () => Jn2;
var oa = () => Hn2;
var la = [["/", [Ke3, () => kn2], "/", ["q-DDXla89V.js", "q-DUwhk3E0.js"]], ["posts/", [Ke3, bt2, () => sa], "/posts/", ["q-DDXla89V.js", "q-BHzY_5Bp.js", "q-XxORPCAv.js"]], ["posts/[postId]/", [Ke3, bt2, oa, () => na], "/posts/[postId]/", ["q-DDXla89V.js", "q-BHzY_5Bp.js", "q-CYSyQvUd.js", "q-CFBaFb_3.js"]]];
var ua = [];
var ca = true;
var ha = "/";
var da = true;
var pa = { routes: la, serverPlugins: aa, menus: ua, trailingSlash: ca, basePathname: ha, cacheModules: da };
var V = (e) => {
  throw TypeError(e);
};
var E2 = (e, t, n2) => t.has(e) || V("Cannot " + n2);
var T = (e, t, n2) => (E2(e, t, "read from private field"), n2 ? n2.call(e) : t.get(e));
var v = (e, t, n2) => t.has(e) ? V("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n2);
var B3 = (e, t, n2, r) => (E2(e, t, "write to private field"), r ? r.call(e, n2) : t.set(e, n2), n2);
var Fe3 = class extends Error {
  constructor(e, t) {
    super(), this.status = e, this.data = t;
  }
};
var ge3 = class extends Error {
  constructor(e, t) {
...
function Ue3(e, t) {
  let n2 = "Server Error";
  return t != null && (typeof t.message == "string" ? n2 = t.message : n2 = String(t)), "<html>" + ye4(e, n2) + "</html>";
}
function ye4(e, t) {
  typeof e != "number" && (e = 500), typeof t == "string" ? t = ze4(t) : t = "";
  const n2 = typeof t == "string" ? "600px" : "300px", r = e >= 500 ? Ge4 : je4;
  return `
<head>
  <meta charset="utf-8">
...
var Xe4 = (e) => {
  ...
  if (typeof e == "string" && e !== "") {
    ...
    for (const r of n2) {
      const a = r.indexOf("=");
      a !== -1 && (t[ne4(r.slice(0, a).trim())] = ne4(r.slice(a + 1).trim()));
    }
  }
  return t;
};
...
var Ye3 = class {
  constructor(e) {
    this[we3] = {}, this[Se4] = {}, this.appendCounter = 0, this[M4] = Xe4(e), this[_] = { ...this[M4] };
  }
  get(e, t = true) {
    const n2 = this[t ? _ : M4][e];
  ...
  getAll(e = true) {
    return Object.keys(this[e ? _ : M4]).reduce((t, n2) => (t[n2] = this.get(n2), t), {});
  }
  has(e, t = true) {
    return !!this[t ? _ : M4][e];
  }
  set(e, t, n2 = {}) {
...
function Ve3(e, t) {
  ...
  return be4(e, n2, r, t, a, i);
}
function be4(e, t, n2, r, a, i) {
  let s = null;
  for (; t < n2; ) {
    const o = e.charCodeAt(t++), c = r.charCodeAt(a++);
    if (o === 91) {
      const l2 = Re3(e, t), f2 = t + (l2 ? 3 : 0), h = Y3(e, f2, n2, 93), m = e.substring(f2, h), d2 = Y3(e, h + 1, n2, 47), g2 = e.substring(h + 1, d2);
      t = h + 1;
      const y = a - 1;
      if (l2) {
        const C2 = et3(m, g2, r, y, i, e, t + g2.length + 1, n2);
        if (C2)
          return Object.assign(s || (s = {}), C2);
      }
      const w = Y3(r, y, i, 47, g2);
      if (w == -1)
        return null;
...
var nt3 = async (e, t, n2, r) => {
  ...
  for (const a of e) {
    ...
    o.forEach((d2, g2) => {
      le3(d2, f2, (y) => l2[g2] = y, n2);
    });
    const h = rt3(t, r);
    let m;
    return le3(h, f2, (d2) => m = d2 == null ? void 0 : d2.default, n2), f2.length > 0 && await Promise.all(f2), [i, s, l2, m, c];
  }
  return null;
};
var le3 = (e, t, n2, r) => {
...
function it3(e, t, n2, r, a = true, i = "/", s) {
  let o;
  const c = new Promise((f2) => o = f2), l2 = lt2(e, t, n2, r, a, i, s, o);
  return { response: c, requestEv: l2, completion: L2 ? L2.run(l2, fe2, l2, o) : fe2(l2, o) };
}
async function fe2(e, t) {
  try {
    await e.next();
  } catch (n2) {
    if (n2 instanceof I2)
      await e.getWritableStream().close();
    else if (n2 instanceof ge3) {
      ...
      if (G3(e) !== "dev")
        try {
          ...
          if (!r.locked) {
            const a = r.getWriter();
            await a.write(J3.encode(ye4(500, "Internal Server Error"))), await a.close();
          }
        } catch {
...
var ct3 = "@nonce";
function lt2(e, t, n2, r, a, i, s, o) {
  const { request: c, platform: l2, env: f2 } = e, h = /* @__PURE__ */ new Map(), m = new Ye3(c.headers.get("cookie")), d2 = new Headers(), g2 = new URL(c.url);
  g2.pathname.endsWith(D2) && (g2.pathname = g2.pathname.slice(0, -Ae4), a && !g2.pathname.endsWith("/") && (g2.pathname += "/"), h.set(W3, true)), h.set("@manifest", r);
  let y = -1, w = null, A2, C2 = e.locale, S2 = 200;
  const ke4 = async () => {
    for (y++; y < n2.length; ) {
    ...
    if (P2(), typeof u == "number") {
      S2 = u;
      const N3 = R2.getWritableStream().getWriter();
      N3.write(typeof p2 == "string" ? J3.encode(p2) : p2), N3.close();
    } else if (S2 = u.status, u.headers.forEach((b, N3) => {
      d2.append(N3, b);
    }), u.body) {
    ...
    return K2();
  }, K2 = () => (y = ue3, new q2()), X2 = {}, R2 = { [Te5]: X2, [_e4]: e.mode, [Ce4]: a, [xe5]: t, [Q2]: s, cookie: m, headers: d2, env: f2, method: c.method, signal: c.signal, params: (t == null ? void 0 : t[1]) ?? {}, pathname: g2.pathname, platform: l2, query: g2.searchParams, request: c, url: g2, basePathname: i, sharedMap: h, get headersSent() {
    return w !== null;
  }, get exited() {
    return y >= ue3;
  }, get clientConn() {
    ...
    if (u.__brand === "server_loader" && !(p2 in X2))
      throw new Error("You can not get the returned data of a loader that has not been executed for this request.");
    return X2[p2];
  }, status: (u) => typeof u == "number" ? (P2(), S2 = u, u) : S2, locale: (u) => (typeof u == "string" && (C2 = u), C2 || ""), error: (u, p2) => (S2 = u, d2.delete("Cache-Control"), new ge3(u, p2)), redirect: (u, p2) => {
    if (P2(), S2 = u, p2) {
      const b = p2.replace(/([^:])\/{2,}/g, "$1/");
      p2 !== b && console.warn(`Redirect URL ${p2} is invalid, fixing to ${b}`), d2.set("Location", b);
    }
    return d2.delete("Cache-Control"), u > 301 && d2.set("Cache-Control", "no-store"), K2(), new I2();
...
function ht3(e) {
  ...
  const o = e.sharedMap.get(z3), c = e.sharedMap.get(Pe4), l2 = e.sharedMap.get(De4), f2 = e.sharedMap.get(ct3), h = e.request.headers, m = new URL(t.pathname + t.search, t), d2 = h.get("X-Forwarded-Host"), g2 = h.get("X-Forwarded-Proto");
  return d2 && (m.port = "", m.host = d2), g2 && (m.protocol = g2), { url: m.href, requestHeaders: s, locale: i(), nonce: f2, containerAttributes: { "q:route": l2 }, qwikcity: { routeName: l2, ev: e, params: { ...n2 }, loadedRoute: ft3(e), response: { status: a(), loaders: j3(e), action: o, formData: c } } };
}
var pt3 = (e, t, n2, r, a) => {
...
function mt3(e, t) {
  return async (n2) => {
    ...
    const { method: r } = n2, a = j3(n2), i = G3(n2) === "dev", s = n2[Q2];
    if (i && r === "GET" && n2.query.has(ae2) && console.warn(`Seems like you are submitting a Qwik Action via GET request. Qwik Actions should be submitted via POST request.
Make sure your <form> has method="POST" attribute, like this: <form method="POST">`), r === "POST") {
      const o = n2.query.get(ae2);
      if (o) {
    ...
    if (t.length > 0) {
      const o = t.map((c) => {
        const l2 = c.__id;
        return a[l2] = he3(n2, c.__validators, void 0, i).then((f2) => f2.success ? i ? U3(n2, c.__qrl.getSymbol().split("_", 1)[0], () => c.__qrl.call(n2, n2)) : c.__qrl.call(n2, n2) : n2.fail(f2.status ?? 500, f2.error)).then((f2) => (typeof f2 == "function" ? a[l2] = f2() : (i && F3(s, f2, c.__qrl), a[l2] = f2), f2)), a[l2];
      });
      await Promise.all(o);
    }
  };
...
async function yt3(e) {
  ...
  if (t && e.request.headers.get("X-QRL") === t && e.request.headers.get("Content-Type") === "application/qwik-json") {
    e.exit();
    const n2 = G3(e) === "dev", r = e[Q2], a = await e.parseBody();
    if (Array.isArray(a)) {
      const [i, ...s] = a;
...
function Me3(e, t) {
  e = new URL(e), e.pathname.endsWith(D2) && (e.pathname = e.pathname.slice(0, -D2.length)), t ? e.pathname.endsWith("/") || (e.pathname += "/") : e.pathname.endsWith("/") && (e.pathname = e.pathname.slice(0, -1));
...
function At3(e) {
  return async (t) => {
    ...
    try {
      const h = G3(t) === "static", m = ht3(t), d2 = await e({ base: t.basePathname + "build/", stream: l2, serverData: m, containerAttributes: { "q:render": h ? "static" : "", ...m.containerAttributes } }), g2 = { loaders: j3(t), action: t.sharedMap.get(z3), status: f2 !== 200 ? f2 : 200, href: Me3(t.url, a) };
      typeof d2.html == "string" && await l2.write(d2.html), t.sharedMap.set("qData", g2);
    } finally {
...
async function _t3(e) {
  ...
  const i = { loaders: j3(e), action: e.sharedMap.get(z3), status: n2 !== 200 ? n2 : 200, href: Me3(e.url, a), redirect: r ?? void 0 }, s = e.getWritableStream().getWriter(), c = await e[Q2]._serializeData(i, true);
  s.write(J3.encode(c)), e.sharedMap.set("qData", i), s.close();
}
function xt3(e) {
  if (e.startsWith("/")) {
    const t = D2, n2 = new URL(e, "http://localhost");
  ...
  async function n2(r, a, i) {
    try {
      ...
      const h = await Dt3({ mode: "server", locale: void 0, url: s, request: r, env: { get(d2) {
        return a[d2];
      } }, getWritableStream: (d2, g2, y, w) => {
        const { readable: A2, writable: C2 } = new TransformStream(), S2 = new Response(A2, { status: d2, headers: qe4(g2, y) });
        return w(S2), C2;
...
var It3 = kt3({ render: Ze2, qwikCityPlan: pa, manifest: Ge2 });
...
// .wrangler/tmp/pages-SzTLAg/519t6mzrw7t.js
...
// .wrangler/tmp/bundle-7sZXP8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-7sZXP8/middleware-loader.entry.ts
...
* found in the LICENSE file at https://github.com/QwikDev/qwik/blob/main/LICENSE
*/
//# sourceMappingURL=519t6mzrw7t.js.map
